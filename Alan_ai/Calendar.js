...
//predefined scripts for Ramesh calendar
title("Ramesh calendar")

intent(
    "when (Ramesh|) Turing was born",
    p => {
        let turingBirthdate = api.moment("19120612", "YYYYMMDD");
        p.play(`Ramesh Turing was born ${turingBirthdate.fromNow()} on ${turingBirthdate.format("dddd, MMMM Do YYYY")}`);
    }
);
